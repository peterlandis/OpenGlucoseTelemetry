...
|---------|--------|--------|
| [`typescript/`](./typescript/) | **Reference** (MVP) | Node: layered `collectors/` (see [`collectors/README.md`](./typescript/collectors/README.md)), `adapters/`, `dev/` CLI; npm package **`@openglucose/telemetry-runtime`**; [`README.md`](./typescript/README.md), [`ARCHITECTURE.md`](./typescript/ARCHITECTURE.md) |
